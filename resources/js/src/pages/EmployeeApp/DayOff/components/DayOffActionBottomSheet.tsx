...
interface DayOffActionBottomSheetProps {
    isOpen: boolean;
    onClose: () => void;
...
export const DayOffActionBottomSheet: React.FC<DayOffActionBottomSheetProps> = ({
    isOpen,
    onClose,
    onConfirm,
    mode,
    ...
    const configs = {
        ...
        cancel: {
            ...
            message: t('cancel_request_msg', 'Are you sure you want to cancel your request? This action cannot be undone.'),
            ...
            <div className="space-y-6 pt-2 pb-6">
                ...
                <div className="flex flex-col gap-3">
                    <Button
                        ...
                        className={cn(
                            "h-14 rounded-2xl font-black text-xs uppercase tracking-widest transition-all active:scale-95 shadow-xl shadow-primary/10",
                    ...
                    <Button
                        ...
                        disabled={isLoading}
                        onClick={onClose}
                        className="h-14 rounded-2xl font-black text-[10px] uppercase tracking-widest text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all active:scale-95"
                    >
                        {t('go_back', 'Go Back')}
                    </Button>
                </div>
