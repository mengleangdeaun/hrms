...
const ResignationIndex = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(t('resignations')));
    }, [t, dispatch]);
                ...
                >
                    <div className="flex flex-col h-full rounded-xl overflow-hidden
                        ...
                        <PerfectScrollbar options={{ suppressScrollX: true }} className="flex-1 min-h-0">
                            <form id="resignation-form" onSubmit={handleSubmit} className="p-6 space-y-8">
                                
                                {/* Block 1: Resignation Details */}
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2 rounded-lg bg-primary/10 text-primary">
                                            <IconUserCircle size={18} />
                                        </div>
                                        <h3 className="text-xs font-black uppercase text-slate-400 tracking-widest">{t('resignation_details_title')}</h3>
                                    </div>
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h3 className="text-xs font-black uppercase text-slate-400 tracking-widest">{t('dates_notice_period_title')}</h3>
                                    </div>
                                    ...
                                    <div className="bg-slate-50/50 dark:bg-slate-800/20 p-5 rounded-xl border border-slate-100 dark:border-slate-800/50 grid grid-cols-1 md:grid-cols-3 gap-5">
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1">{t('resignation_date_label')} <span className="text-rose-500">*</span></Label>
                                            <DatePicker
                                        ...
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1">{t('last_working_day_label')} <span className="text-rose-500">*</span></Label>
                                            <DatePicker
                                    ...
                                    <div className="bg-slate-50/50 dark:bg-slate-800/20 p-5 rounded-xl border border-slate-100 dark:border-slate-800/50 space-y-5">
                                        <div className="space-y-1.5">
                                            ...
                                            <Input
                                                ...
                                                onChange={handleChange}
                                                placeholder={t('resignation_reason_placeholder')}
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Textarea
                                                ...
                                                onChange={handleChange}
                                                placeholder={t('resignation_description_placeholder')}
                                                rows={3}
                                    ...
                                    <div className="bg-slate-50/50 dark:bg-slate-800/20 p-5 rounded-xl border border-slate-100 dark:border-slate-800/50 flex flex-col items-center justify-center min-h-[160px] relative group cursor-pointer overflow-hidden transition-all hover:border-primary/50"
                                        ...
                                        {formData.document ? (
                                            <div className="w-full h-full flex flex-col items-center justify-center p-4">
                                                ...
                                                <p className="text-xs font-bold text-slate-700 dark:text-slate-200">{t('resignation_document_label')}</p>
                                            ...
                                            <div className="flex flex-col items-center justify-center text-center p-6 space-y-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-bold text-slate-600 dark:text-slate-300 group-hover:text-primary transition-colors">{t('resignation_document_label')}</p>
                        ...
                        <div className="shrink-0 flex items-center justify-between px-6 py-5 border-t border-slate-100 dark:border-slate-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-b-xl">
                            ...
                            <div className="flex gap-3 w-full sm:w-auto">
                                ...
                                >
                                    ...
                                    {isSaving ? t('saving_label') : (editingItem ? t('save_changes_btn_label') : t('record_resignation_add'))}
                                </Button>
                            </div>
                        </div>
                    </div>
